...
export class ScoringEngine {
   ...
   */
  calculateScore(item: InventoryItem, preferences: UserPreferences): ScoredItem {
    const matchDetails = {
   ...
   */
  private matchGender(item: InventoryItem, preferences: UserPreferences): number {
   ...
   */
  private matchWeather(item: InventoryItem, preferences: UserPreferences): number {
   ...
   */
  private matchLifestyle(item: InventoryItem, preferences: UserPreferences): number {
   ...
   * Match body type
   */
  private matchBodyType(item: InventoryItem, preferences: UserPreferences): number {
    ...
    const bodyTypeSimilarity: Record<string, string[]> = {
   ...
   */
  private matchStyle(item: InventoryItem, preferences: UserPreferences): number {
    ...
    const matches = userStyles.filter(userStyle => 
   ...
   */
  private matchSkinTone(item: InventoryItem, preferences: UserPreferences): number {
   ...
   */
  scoreItems(items: InventoryItem[], preferences: UserPreferences): ScoredItem[] {
